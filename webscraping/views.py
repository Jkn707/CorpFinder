            ...
            if opciones:
                ...
                if datos_empresa:
                    ...
                    for comentario in comentarios:
                        nuevo_comentario = ComentariosComputrabajo(fecha=comentario['fecha'], contenido=comentario['contenido'], empresa=nueva_empresa, calificacion=comentario['calificacion'])
